...
class Yolo_Dect:
    ...
    def image_callback(self, image):
        ...
        # print(boxs.shape) person(1,7)
        self.dectshow(self.color_image, boxs, image.height, image.width)

        cv2.waitKey(3)

        # print("boxs[-1]:",boxs[0,-1])
        # print("results.pandas():",results.pandas().xyxy[0].values)
    ...
    def dectshow(self, org_img, boxs, height, width):
        ...
        for box in boxs:
            ...
            # print("boundingBox.ymin :",boundingBox.ymin)
            if box[1] < 20:
                text_pos_y = box[1] + 30
            else:
                text_pos_y = box[1] - 10
            ...
            if boxs.shape == (1,7):
                print(boxs.shape)
                print("boundingBox.ymax :",480 - boundingBox.ymax)
